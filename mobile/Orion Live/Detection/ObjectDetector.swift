...
//  Core object detection logic using YOLO and Vision for Orion Live.
        ...
        modelQueue.async { [weak self] in
            ...
            do {
                guard let modelURL = Bundle.main.url(forResource: "yolo11n", withExtension: "mlmodelc") else {
                    Logger.shared.log("YOLO11n compiled model file not found in bundle")
                    return
                }
                ...
                DispatchQueue.main.async {
                    ...
                    Logger.shared.log("YOLO11n model loaded successfully")
                }
                
            } catch {
                Logger.shared.log("Failed to load YOLO11n model: \(error)")
            }
        }
    }
