                    ...
                    if isEditingPrompt {
                        ...
                        Menu {
                            Button("Describe image") {
                                prompt = "Generate a rich, structured, and detailed description that includes: 1. Main Focus – What is the primary object, person, or action in the scene? 2. Surrounding Objects & Context – List and describe notable secondary objects, people, or environment details. 3. Spatial Relationships – Describe where the objects are relative to one another. 4. Activities & Interactions – What are people or objects doing? Are there interactions or implied motions? 5. Scene Type & Time – Describe the overall type of scene (e.g. urban street, kitchen, park) and visible time of day. 8. Inferences & Intent – Based on visual cues, infer what might have just happened or what might happen next. 7. Style & Aesthetic – Describe the scene’s mood, lighting, or style (e.g. bright, moody, colorful).\n\n Your goal: make your description so complete and detailed that an image generator could reconstruct the scene with full visual accuracy from your output alone."
                                promptSuffix = "Limit your response to under 256 tokens."
                            }
