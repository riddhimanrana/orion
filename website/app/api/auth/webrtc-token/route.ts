...
export async function POST(request: Request) {
  return trackApiRoute(request, { action: "auth.webrtc_token" }, async (usage) => {
    ...
    try {
      ...
      usage.addMetadata({ pairId: pair.id });
