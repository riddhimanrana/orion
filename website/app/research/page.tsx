        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center space-y-6">
            ...
            <p className="text-sm md:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              ...
              scalable, real-time scene understanding. I have not yet completed my research and work so this is just a preview of what I have done so far.
            </p>
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                I have released my fine-tuned FastVLM-0.5b model and the
                custom COCO dataset used for validation. Explore the model and
                dataset on Huggingface, and check out the complete codebase on
                GitHub. I plan to formally publish this research in about one
                year through a professor-led collaboration.
              </p>
